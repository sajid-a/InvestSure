...
$report = "Email Id not registered. Please Register yourself.";


}
$check_user_data2 = mysql_query("SELECT * FROM `members` WHERE `phone` = '$mobile'") or die(mysql_error());
if(mysql_num_rows($check_user_data2) == 0){


$report = "Mobile number not registered. Please register yourself.";

}
$get_user_data = mysql_fetch_array($check_user_data);
if($get_user_data['phone'] == $phone)
{

$to = $uid;
$subject = "Investsure Password";

$message = "
<html>
<head>
<title>Investsure Email</title>
</head>
<body>
<p>This is in response to your request to retrieve password on <a href = 'http://www.investsure.co.in' target = '_blank'>www.investsure.co.in</a>. 
Your password is: ".$get_user_data['pass']."
</p>
<p>
If you did not send such a request please report it to the Investsure team at the earliest.
</p>
<p>
<br />
Regards,
...
// More headers
$headers .= 'From: Investsure<no-reply@investsure.co.in>' . "\r\n";
$test = false;
$test = mail($to,$subject,$message,$headers);

if ($test){
$report = "The password has been sent to your email id registered with us. <br/>Please check your email and proceed to login with the retrieved password.";
}
else {
$report = "Mail Server unavailable.";
}
}
else
{
...
<title>InvestSure | Forgot Password</title>
        ...
        <h2>Retrieve Password</h2>
                 ...
                 <form method = "post">
                  ...
                  <p style = "margin-left: 80px;"> <?php echo $report; ?><br /><br /> </p>
                    ...
                    <label>Mobile:</label><input type="text" name="phone" class="contact_input" />
