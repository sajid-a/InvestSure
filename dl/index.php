...
$result = mysql_query("select * from blog where id = $id") or die(mysql_error());
$pdf = mysql_fetch_array($result);
echo "<script>document.location.href='".$pdf['title'].".pdf';</script>";
	...
	<div id="header">
        ...
        <div id="menu">
            <ul id="menu1">                                        
                ...
                <li><a href="../blog.php" title="" class="current">Blog</a></li>
...
InvestSure is an initiatice by Mrs. Veena Kamat and Mr. Naresh Natwal to provide professional and easy Insurance Advice to the public.	        
 ...
 <h3>To Download an Article</h3>  
            <p>         
If you are an Existing Member, please <a href="../login.php">LOGIN.</a><br /><br />
If you are a New Member, please <a href="../register.php">REGISTER</a> and then <a href="../login.php">LOGIN </a> <br />  <br /> <br />
            </p>
           <div class="read_more_link"> <a href="../blog.php">Return to Blog</a> </div>
            </div>
